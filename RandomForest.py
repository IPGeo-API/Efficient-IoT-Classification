...
def Random_Search():
    ...
    model_path = '/home/Username/path/trained_models/sklearn_rf_classify.pkl'
    ...
    false_positive, true_positive, threshold = roc_curve(y_test, y_predicted)
    pd.DataFrame({"FalsePositiveRate" : false_positive, "TruePositiveRate" :true_positive, "Threshold" : threshold}).to_csv("/home/Username/path/RF-ROC.csv", index=None)
